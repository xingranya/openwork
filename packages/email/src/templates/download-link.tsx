...
export function DownloadLinkEmail({ organizationName, downloadUrl }: DownloadLinkEmailProps) {
  const intro = organizationName
    ? `Here's your link to download the SeeWayWork desktop app for ${organizationName}.`
    : "Here's your link to download the SeeWayWork desktop app."

  return (
    <Html>
      <Head />
      <Preview>Your SeeWayWork download link</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Text style={styles.eyebrow}>SeeWayWork desktop</Text>
          <Heading style={styles.heading}>Download SeeWayWork</Heading>
          ...
          <Button href={downloadUrl} style={styles.button}>Download SeeWayWork</Button>
