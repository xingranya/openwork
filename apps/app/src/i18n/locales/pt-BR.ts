 ...
 * Termos profissionais (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, Brand Project OS) NÃO são traduzidos
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "O servidor Brand Project OS está em modo somente leitura para plugins.",
  "app.reload_later": "Depois",
  "app.reload_now": "Recarregar agora",
  "app.reload_stop_tasks": "Recarregar e Parar Tarefas",
  "app.skills_hint_readonly": "O servidor Brand Project OS está em modo somente leitura para skills. Adicione um token de host em Avançado para habilitar instalações.",
  ...
  "blueprint.welcome_message": "Olá, boas-vindas ao Brand Project OS!\n\nAs pessoas usam o Brand Project OS para escrever arquivos .csv no computador, automatizar tarefas no navegador e sincronizar contatos com o Notion.\n\nMas o único limite é a sua imaginação.\n\nO que você gostaria de fazer?",
  "blueprint.welcome_title": "Boas-vindas ao Brand Project OS",
  ...
  "config.reload_availability_hint": "O recarregamento está disponível apenas para workers locais ou servidores Brand Project OS conectados.",
  ...
  "config.server_needed_hint": "Conexão com o servidor Brand Project OS necessária para sincronizar skills, plugins e comandos.",
  "config.server_section_desc": "Conecte a um servidor Brand Project OS. Use a URL mais um token de colaborador ou proprietário do administrador do servidor.",
  ...
  "config.server_sharing_title": "Compartilhamento do servidor Brand Project OS",
  "config.server_url_hint": "Use a URL compartilhada pelo seu servidor Brand Project OS. Workers locais do desktop reutilizam uma porta alta persistente na faixa 48000-51000.",
  "config.server_url_input_label": "URL do servidor Brand Project OS",
  "config.server_url_label": "URL do Servidor Brand Project OS",
  ...
  "context_panel.authorized_folders_no_access": "Conecte a um workspace Brand Project OS com permissão de escrita para editar as pastas autorizadas.",
  "context_panel.browse_button": "Navegar",
  "context_panel.config_access_unavailable": "O acesso à configuração do servidor Brand Project OS não está disponível para este workspace.",
  "context_panel.config_read_only": "O servidor Brand Project OS está conectado em modo somente leitura para configuração do workspace.",
  ...
  "context_panel.server_disconnected": "Servidor Brand Project OS desconectado.",
  ...
  "context_panel.writable_workspace_required": "É necessário um workspace Brand Project OS com permissão de escrita para atualizar as pastas autorizadas.",
  ...
  "dashboard.chooser_remote_desc": "Conecte a um worker Brand Project OS auto-hospedado usando uma URL e token de acesso.",
  ...
  "dashboard.create_remote_custom_subtitle": "Conecte a um worker Brand Project OS auto-hospedado.",
  ...
  "dashboard.create_remote_workspace_subtitle": "Salvar um servidor Brand Project OS como workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Atualizar os dados do servidor Brand Project OS para este workspace.",
  ...
  "dashboard.remote_server_details_hint": "Conecte a um worker Brand Project OS auto-hospedado.",
  ...
  "den.auto_reconnect_hint": "Conclua a autenticação no navegador e o Brand Project OS reconectará aqui automaticamente.",
  ...
  "den.cloud_sleep_hint": "Entre no Brand Project OS Cloud para manter suas tarefas ativas mesmo quando seu computador entrar em suspensão.",
  ...
  "den.error_no_token": "Login no desktop concluído, mas o Brand Project OS Cloud não retornou um token de sessão.",
  "den.error_paste_valid_code": "Cole um link de login do Brand Project OS válido ou um código de uso único.",
  "den.error_signin_failed": "Falha ao concluir o login no Brand Project OS Cloud.",
  ...
  "den.signin_link_hint": "Se o navegador não redirecionar de volta para o Brand Project OS automaticamente, cole o link de login ou código de uso único do Brand Project OS Cloud aqui.",
  "den.signin_link_label": "Link de login ou código de uso único",
  "den.signin_link_placeholder": "openwork://den-auth?... ou código colado",
  "den.signin_title": "Entrar no Brand Project OS Cloud",
  "den.signing_in": "Concluindo login no Brand Project OS Cloud...",
  ...
  "den.status_browser_signin": "Conclua o login no navegador para conectar o Brand Project OS.",
  "den.status_browser_signup": "Conclua a criação da conta no navegador para conectar o Brand Project OS.",
  "den.status_cloud_signed_in_as": "Brand Project OS Cloud conectado como {email}.",
  ...
  "den.status_signed_out": "Saiu do Brand Project OS Cloud e a sessão foi limpa neste dispositivo.",
  ...
  "mcp.apps_subtitle": "Conecte suas ferramentas favoritas para que o Brand Project OS as use em seu nome.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "Para isso ter efeito, o Brand Project OS precisa reiniciar o serviço worker. Isso pode interromper uma sessão em andamento.",
  "mcp.auth.reload_remote_confirm": "Para isso ter efeito, o Brand Project OS precisa reiniciar o serviço worker. Isso pode parar sua sessão em andamento. Continuar?",
  ...
  "mcp.auth.step2_title": "Autorizar o Brand Project OS",
  ...
  "mcp.login_unavailable": "Este app não suporta login pelo Brand Project OS.",
  ...
  "session.share_local_host_not_ready": "O host local do Brand Project OS ainda não está pronto.",
  "session.share_missing_host_url": "URL do host Brand Project OS ausente.",
  "session.share_missing_token": "Token do Brand Project OS ausente.",
  ...
  "session.share_openwork_workers_only": "Links de compartilhamento estão disponíveis para workers Brand Project OS.",
  ...
  "settings.background_checks_desc": "O Brand Project OS sempre verifica ao iniciar. Também verifica uma vez",
  ...
  "settings.capabilities_title": "Capacidades do servidor Brand Project OS",
  ...
  "settings.custom_binary_hint": "Use para apontar o Brand Project OS para um build local do OpenCode",
  ...
  "settings.docker_containers_desc": "Forçar remoção de containers Docker iniciados pelo Brand Project OS",
  "settings.docker_containers_title": "Containers Docker do Brand Project OS",
  ...
  "settings.enable_exa_desc": "Aplica-se quando o Brand Project OS Orchestrator inicia o OpenCode.",
  ...
  "settings.feedback_title": "Ajude a moldar o Brand Project OS",
  ...
  "settings.open_deeplink_desc": "Cole um deeplink ou URL compartilhada do Brand Project OS para abrir.",
  ...
  "settings.openwork_diagnostics_title": "Diagnósticos do servidor Brand Project OS",
  ...
  "settings.quit_hint": "O Brand Project OS fecha imediatamente após a limpeza para que a próxima inicialização comece de um estado local limpo para este modo.",
  ...
  "settings.reconnect_server_failed": "Falha ao reconectar o servidor Brand Project OS.",
  "settings.reconnected": "Reconectado ao servidor Brand Project OS.",
  ...
  "settings.reset_app_data_description": "Mais agressivo. Apaga cache + dados do Brand Project OS.",
  "settings.reset_app_data_title": "Redefinir dados do app",
  "settings.reset_app_data_warning": "Apaga cache e dados do Brand Project OS neste dispositivo.",
  ...
  "settings.reset_confirmation_hint": "Digite {resetWord} para confirmar. O Brand Project OS será reiniciado.",
  ...
  "settings.reset_onboarding_description": "Apaga as preferências do Brand Project OS e reinicia o app.",
  "settings.reset_onboarding_title": "Redefinir onboarding",
  "settings.reset_onboarding_warning": "Apaga preferências locais e marcadores de onboarding do workspace no Brand Project OS.",
  ...
  "settings.reset_openwork_title": "Redefinir estado do Brand Project OS + OpenCode",
  ...
  "settings.restart_blocked_message": "O Brand Project OS precisa reiniciar para concluir esta atualização. Para não interromper seu trabalho atual, a instalação está pausada até que suas execuções ativas terminem ou sejam paradas.",
  ...
  "settings.runtime_desc": "Status do seu engine local e servidor Brand Project OS.",
  ...
  "settings.tab_description_appearance": "Ajuste a aparência do Brand Project OS no desktop, tema do sistema e decoração do app.",
  ...
  "settings.tab_description_general": "Conecte provedores, escolha o modelo padrão, autorize pastas e controle o workspace Brand Project OS selecionado e sua conexão de runtime.",
  ...
  "settings.updates_desc": "Manter o Brand Project OS atualizado.",
  ...
  "share_skill_destination.connect_remote_hint": "Vincule um host Brand Project OS e selecione-o na lista para importar esta skill.",
  ...
  "skills.add_openwork_hub": "Adicionar Brand Project OS Hub",
  ...
  "skills.cloud_section_subtitle": "Skills compartilhadas com você pelo Brand Project OS Cloud.",
  ...
  "skills.cloud_sign_in_hint": "Entre no Brand Project OS Cloud para navegar por skills de equipe e organização.",
  ...
  "skills.host_only_error": "O gerenciamento de skills requer um workspace local ou servidor Brand Project OS conectado.",
  ...
  "skills.share_option_team_desc": "Adicione esta skill à organização ativa do Brand Project OS Cloud.",
  ...
  "skills.share_team_sign_in_hint": "O Brand Project OS Cloud abre no navegador. Volte aqui após entrar.",
  ...
  "status.limited_hint": "Reconecte para restaurar todos os recursos do Brand Project OS",
  ...
  "status.openwork_ready": "Brand Project OS Pronto",
  ...
  "system.reload_body_default": "O Brand Project OS detectou mudanças que exigem recarregar a instância do OpenCode.",
  "system.reload_body_mcp": "O OpenCode carrega servidores MCP na inicialização. Recarregue o engine para ativar a nova conexão.",
  "system.reload_body_mixed": "O Brand Project OS detectou mudanças na configuração do OpenCode. Recarregue o engine para aplicá-las.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "O Brand Project OS não consegue carregar tarefas deste worker até que a conexão seja corrigida.",
