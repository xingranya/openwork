 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, Brand Project OS) are NOT translated
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "Brand Project OS server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "Brand Project OS server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "blueprint.welcome_message": "Hi welcome to Brand Project OS!\n\nPeople use us to write .csv files on their computer, automate browser tasks, and sync contacts to Notion.\n\nBut the only limit is your imagination.\n\nWhat would you want to do?",
  "blueprint.welcome_title": "Welcome to Brand Project OS",
  "brand_project.actions": "Actions",
  "brand_project.approval_boundary": "{actor} confirms formal changes. AI can only propose them.",
  "brand_project.approve": "Approve",
  "brand_project.change": "Change",
  "brand_project.change_type": "Type",
  "brand_project.current_state": "Current approved state",
  "brand_project.empty_current_state": "No state has been approved by a person yet.",
  "brand_project.empty_evidence": "This change has no available evidence reference.",
  "brand_project.empty_known_gaps": "No source gaps are recorded.",
  "brand_project.empty_open_questions": "There are no open questions.",
  "brand_project.empty_proposals": "There are no changes waiting for your review.",
  "brand_project.empty_sources": "No project sources are registered.",
  "brand_project.empty_tasks": "No project tasks are registered.",
  "brand_project.error_unknown": "The operation did not complete. Try again.",
  "brand_project.evidence": "Evidence",
  "brand_project.evidence_confirmed": "Located",
  "brand_project.evidence_unconfirmed": "Unconfirmed",
  "brand_project.known_gaps": "Missing source material",
  "brand_project.loading": "Loading project state...",
  "brand_project.metric_gaps": "Source gaps",
  "brand_project.metric_pending": "Waiting for you",
  "brand_project.metric_sources": "Registered sources",
  "brand_project.metric_state": "Approved state",
  "brand_project.mode": "Work stage",
  "brand_project.mode_decision": "Confirm direction",
  "brand_project.mode_evaluation": "Evaluate options",
  "brand_project.mode_execution": "Execute",
  "brand_project.mode_exploration": "Explore",
  "brand_project.modify_approve": "Edit and approve",
  "brand_project.not_connected": "The company business service is not connected.",
  "brand_project.open_change": "Open change",
  "brand_project.open_questions": "Open questions",
  "brand_project.reject": "Reject",
  "brand_project.review_content": "Approved structured content",
  "brand_project.review_content_invalid": "The edited content must be a valid JSON object.",
  "brand_project.review_cancelled": "Cancelled. Nothing was written to the approved state.",
  "brand_project.review_reason": "Your review note",
  "brand_project.review_reason_placeholder": "Explain why you are approving, editing, or rejecting this change.",
  "brand_project.review_reason_required": "Add a review note first.",
  "brand_project.role": "AI role",
  "brand_project.role_creative": "Creative partner",
  "brand_project.role_execution": "Execution partner",
  "brand_project.role_researcher": "Brand researcher",
  "brand_project.role_strategist": "Brand strategist",
  "brand_project.sidebar": "Project work",
  "brand_project.source_check": "Content check",
  "brand_project.source_name": "Source",
  "brand_project.source_role": "Purpose",
  "brand_project.source_version": "Version",
  "brand_project.start_ai": "Send to AI",
  "brand_project.state_version": "Approved state version {version}",
  "brand_project.status": "Status",
  "brand_project.status_approved": "Approved",
  "brand_project.status_pending": "Pending",
  "brand_project.status_rejected": "Rejected",
  "brand_project.status_superseded": "Superseded",
  "brand_project.tab_overview": "Overview",
  "brand_project.tab_proposals": "Changes to review",
  "brand_project.tab_sources": "Sources",
  "brand_project.tab_tasks": "Tasks",
  "brand_project.task": "Task",
  "brand_project.task_context": "Task context",
  "brand_project.task_goal": "Goal",
  "brand_project.type_action": "Action to confirm",
  "brand_project.type_change": "Project change",
  "brand_project.type_constraint": "Constraint to confirm",
  "brand_project.type_decision": "Decision to confirm",
  "brand_project.type_fact": "Fact",
  "brand_project.type_hypothesis": "Hypothesis",
  "brand_project.type_open_question": "Open question",
  "brand_project.type_option": "Option",
  "brand_project.type_preference": "Preference",
  "brand_project.type_target_date": "Target date",
  "brand_project.type_tendency": "Tendency",
  "brand_project.type_view": "View",
  "brand_project.unavailable": "Project state is temporarily unavailable",
  "brand_project.untitled_item": "Untitled item",
  "brand_project.updated": "Updated",
  "brand_project.updated_at": "Updated {time}",
  "brand_project.version_check": "Version check",
  "brand_project.view_task_context": "View task",
  "brand_project.workspace": "Business project",
  "common.add": "Add",
  ...
  "connect.connected_to_cloud": "Connected to Brand Project OS Cloud",
  "connect.connected_to_org": "Connected to {name}",
  "connect.diagnostics_action_label": "Recommended action",
  "connect.diagnostics_agent_description": "Redacted evidence from the server-computed Brand Project OS agent configuration intent. Effective engine state was not observed.",
  "connect.diagnostics_agent_description_effective": "Redacted evidence from the effective engine-resolved Brand Project OS agent and its context markers.",
  ...
  "connect.diagnostics_check_agent_resolution": "Brand Project OS agent configuration intent",
  "connect.diagnostics_check_agent_resolution_effective": "Effective Brand Project OS agent resolution",
  "connect.diagnostics_check_cloud_tool_catalog": "Brand Project OS Cloud tool catalog",
  ...
  "connect.diagnostics_global_cloud_mcp": "Global Brand Project OS Cloud MCP",
  ...
  "connect.diagnostics_mcp_description_effective": "The engine's merged configuration and Brand Project OS-managed dynamic injection intent are shown separately. Runtime rows include exact registration outcomes; this is not a complete live tool-registry snapshot.",
  ...
  "connect.diagnostics_org_description": "These connections operate behind the single Brand Project OS Cloud meta-MCP and are not injected as separate engine MCPs.",
  ...
  "connect.diagnostics_owner_openwork_client": "Brand Project OS client",
  "connect.diagnostics_owner_openwork_server": "Brand Project OS server",
  "connect.diagnostics_owner_openwork_support": "Brand Project OS support",
  ...
  "connect.diagnostics_configured_agent": "Configured Brand Project OS agent",
  "connect.diagnostics_effective_agent": "Effective Brand Project OS agent",
  "connect.diagnostics_agent_state": "Brand Project OS agent state",
  ...
  "connect.diagnostics_unavailable_direct_opencode": "For privacy, agent diagnostics are unavailable for direct remote OpenCode workspaces. Use a remote Brand Project OS workspace to run this report.",
  "connect.diagnostics_workspace_cloud_mcp": "Selected workspace Brand Project OS Cloud MCP",
  ...
  "connect.header_description": "Use team-approved cloud connections shared from Brand Project OS Den.",
  ...
  "connect.pitch_title": "Connect is the new way Brand Project OS lets you share workflows with your team.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected Brand Project OS servers.",
  ...
  "config.server_needed_hint": "Brand Project OS server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to an Brand Project OS server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "Brand Project OS server",
  ...
  "config.server_sharing_title": "Brand Project OS server sharing",
  "config.server_url_hint": "Use the URL shared by your Brand Project OS server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "Brand Project OS server URL",
  "config.server_url_label": "Brand Project OS Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable Brand Project OS server workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "Brand Project OS server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "Brand Project OS server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "Brand Project OS server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable Brand Project OS server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted Brand Project OS worker using a URL and access token.",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted Brand Project OS worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save an Brand Project OS server as a workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the Brand Project OS server details for this workspace.",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted Brand Project OS worker.",
  ...
  "connect.error_unknown_kid": "This link was signed with a newer key than this app knows. Update Brand Project OS and try again.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and Brand Project OS will reconnect here automatically.",
  ...
  "den.cloud_section_desc": "Sign in and pick an organization to access Brand Project OS Cloud.",
  "den.cloud_section_title": "Brand Project OS Cloud",
  "den.cloud_sleep_hint": "Sign in to Brand Project OS Cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_signed_in_desc": "You are signed in and ready to use Brand Project OS Cloud.",
  "den.cloud_unavailable_body": "Local work remains available. Reconnecting automatically.",
  "den.cloud_unavailable_title": "Brand Project OS Cloud is temporarily unavailable.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but Brand Project OS Cloud did not return a session token.",
  "den.error_paste_valid_code": "Paste a valid Brand Project OS sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete Brand Project OS Cloud sign-in.",
  "den.error_signout_failed": "Could not sign out of Brand Project OS Cloud. Try again.",
  ...
  "den.signin_link_hint": "If your browser doesn't bounce back into Brand Project OS automatically, paste the sign-in link or one-time code from Brand Project OS Cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "openwork://den-auth?... or pasted code",
  "den.signin_title": "Sign in to Brand Project OS Cloud",
  "den.signing_in": "Finishing Brand Project OS Cloud sign-in...",
  "den.signing_out": "Signing out...",
  "den.status_base_url_updated": "Updated the Cloud control plane URL. Sign in again to continue.",
  "den.status_browser_signin": "Finish signing in in your browser to connect Brand Project OS.",
  "den.status_browser_signup": "Finish account creation in your browser to connect Brand Project OS.",
  "den.status_cloud_signed_in_as": "Connected Brand Project OS Cloud as {email}.",
  "den.status_cloud_signin_done": "Connected Brand Project OS Cloud.",
  ...
  "den.status_signed_out": "Signed out and cleared your Brand Project OS Cloud session on this device.",
  "den.status_server_config_cleared": "Cleared the desktop server configuration. Brand Project OS is using the default Cloud control plane.",
  "den.sync": "Sync",
  ...
  "extensions.marketplace_description": "Browse Brand Project OS built-ins and organization marketplace extensions. Built-ins stay local; organization marketplace extensions run through Brand Project OS Connect, while GitHub and Claude plugin imports live in local Extensions.",
  ...
  "mcp.toggle_requires_server": "Connect to an Brand Project OS server to enable or disable MCPs.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so Brand Project OS can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, Brand Project OS needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, Brand Project OS needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize Brand Project OS",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from Brand Project OS.",
  ...
  "mcp.quick_connect_openwork_cloud_title": "Brand Project OS Cloud Control",
  "mcp.quick_connect_openwork_ui_desc": "Let agents see and drive the Brand Project OS app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_openwork_ui_title": "Brand Project OS UI Control",
  ...
  "notifications.empty_hint": "Updates from Brand Project OS Cloud and your workspaces will show up here.",
  "notifications.engine_reloaded": "Updates applied",
  "notifications.just_now": "Just now",
  "notifications.reconnect_failed": "Couldn't reconnect to the Brand Project OS server",
  ...
  "welcome.title": "Welcome to Brand Project OS",
  ...
  "welcome.organization_server_dialog_desc": "Paste the server URL your IT team shared. Brand Project OS will use it before sign-in and cloud features.",
  "welcome.organization_server_dialog_title": "Connect to your organization's server",
  "welcome.organization_server_error": "Enter a valid http:// or https:// Brand Project OS server URL.",
  "welcome.organization_server_link": "Using Brand Project OS on-premises?",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. Brand Project OS will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and Brand Project OS can pick them up.",
  "plugins.add": "Add",
  ...
  "session.share_local_host_not_ready": "Local Brand Project OS host is not ready yet.",
  "session.share_missing_host_url": "Missing Brand Project OS host URL.",
  "session.share_missing_token": "Missing Brand Project OS token.",
  ...
  "session.share_openwork_workers_only": "Share service links are available for Brand Project OS workers.",
  ...
  "settings.privacy_section_desc": "Control what Brand Project OS shares to improve the product.",
  ...
  "settings.capabilities_title": "Brand Project OS server capabilities",
  ...
  "settings.custom_binary_hint": "Use this to point Brand Project OS at a local OpenCode build",
  ...
  "settings.debug_openwork_server_version": "Brand Project OS server: {version}",
  ...
  "settings.runtime_config_one_writer_rule": "Brand Project OS writes only the managed runtime config file; user OpenCode config stays user-owned.",
  ...
  "settings.runtime_config_no_removed_keys": "No Brand Project OS-managed keys removed.",
  ...
  "settings.desktop_notifications.mode_desc": "Choose which Brand Project OS events can appear as native operating system notifications.",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by Brand Project OS. Off by default.",
  ...
  "settings.feedback_title": "Help shape Brand Project OS",
  ...
  "settings.open_deeplink_desc": "Paste an Brand Project OS deeplink or share URL to open it.",
  ...
  "settings.organization_server_default": "Using standard Brand Project OS Cloud.",
  "settings.organization_server_desc": "Point Brand Project OS at the server your organization hosts. This is available without developer mode.",
  "settings.organization_server_title": "Organization server",
  "settings.organization_server_url_hint": "Paste your organization's Brand Project OS server URL. Saving signs you out so Brand Project OS can re-hydrate against that server.",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by Brand Project OS.",
  ...
  "settings.openwork_config_sidecar_desc": "Local Brand Project OS server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  "settings.openwork_diagnostics_title": "Brand Project OS server diagnostics",
  "settings.openwork_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.openwork_server_label": "Brand Project OS server",
  ...
  "settings.quit_hint": "Brand Project OS quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect Brand Project OS server.",
  "settings.reconnected": "Reconnected to Brand Project OS server.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears Brand Project OS cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears Brand Project OS cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. Brand Project OS will restart.",
  ...
  "settings.reset_onboarding_description": "Clears Brand Project OS preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears Brand Project OS local preferences and workspace onboarding markers.",
  ...
  "settings.reset_openwork_title": "Reset Brand Project OS + OpenCode state",
  ...
  "settings.restart_blocked_message": "The update is ready, but Brand Project OS will wait until your active tasks finish before restarting. You can also stop them manually.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_opencode": "Restart OpenCode",
  "settings.restart_openwork_server": "Restart Brand Project OS server",
  ...
  "settings.services_section_desc": "Local services that power this Brand Project OS session. Each service has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting Brand Project OS.",
  ...
  "settings.server_endpoints_desc": "Read-only view of the URLs Brand Project OS will use after local overrides and bootstrap files are applied.",
  ...
  "settings.runtime_desc": "Status for your local engine and Brand Project OS server.",
  ...
  "settings.tab_connect": "Brand Project OS Connect",
  ...
  "settings.tab_description_appearance": "Adjust how Brand Project OS looks across desktop, system theme, and app frame.",
  ...
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected Brand Project OS workspace plus its runtime connection.",
  ...
  "settings.environment.override_hint": "Environment variables set before Brand Project OS starts take precedence over values saved here.",
  ...
  "settings.environment.apply_confirm_body": "Brand Project OS will restart local agents so they can use the latest environment. Running local tasks may stop.",
  "settings.environment.apply_no_local_workspace": "Brand Project OS is not connected to a local workspace.",
  ...
  "settings.environment.apply_refresh_failed": "Changes are active, but Brand Project OS status did not refresh. Reopen the app if it looks stale.",
  ...
  "settings.environment.validation_reserved": "OPENWORK_ and OPENCODE_ names are managed by Brand Project OS/OpenCode.",
  ...
  "memory.sign_in_hint": "Sign in to your Brand Project OS account to view your memory bank.",
  ...
  "settings.update_blocked_org": "Brand Project OS {version} is available, but your organization has not approved it yet. Ask an organization administrator to enable this version.",
  ...
  "settings.update_restart_active_tasks": "You have active tasks. Installing the update restarts Brand Project OS and will interrupt them.",
  "settings.update_restart_confirm_title": "Restart with active tasks?",
  "settings.update_restart_confirm_message": "Installing the update restarts Brand Project OS now and interrupts your active tasks. You may need to resume them after the update.",
  "settings.update_uptodate": "You're up to date",
  "settings.updates": "Updates",
  "settings.updates_desc": "Keep Brand Project OS up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach an Brand Project OS host, then choose it from the list to import this skill.",
  ...
  "skills.add_openwork_hub": "Add Brand Project OS Hub",
  ...
  "skills.cloud_org_fallback": "Brand Project OS Cloud",
  "skills.cloud_org_load_failed": "Failed to load organization skills.",
  "skills.cloud_refresh": "Refresh team skills",
  "skills.cloud_section_subtitle": "Skills shared with you through Brand Project OS Cloud.",
  ...
  "skills.cloud_sign_in_hint": "Sign in to Brand Project OS Cloud to browse team and org skills.",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected Brand Project OS server.",
  ...
  "skills.share_option_team_desc": "Add this skill to your active Brand Project OS Cloud organization.",
  ...
  "skills.share_team_permissions_intro": "Upload this skill to your active Brand Project OS Cloud organization and decide who can see it.",
  ...
  "skills.share_team_sign_in_hint": "Brand Project OS Cloud opens in your browser. Return here after signing in.",
  ...
  "status.limited_hint": "Reconnect to restore full Brand Project OS features",
  ...
  "status.openwork_ready": "Brand Project OS Ready",
  ...
  "system.reload_body_default": "Brand Project OS detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "Brand Project OS detected OpenCode configuration changes. Reload the engine to apply them.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "Brand Project OS can't load tasks from this worker until the connection is fixed.",
