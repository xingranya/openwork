    ...
    <SettingsListItem>
      <SettingsListItemContent>
        <SettingsListTitle>
          ...
          {row.skill?.shared === "public" ? (
            <SettingsPill>{t("skills.cloud_shared_public")}</SettingsPill>
          ) : null}
          {row.skill?.shared === null ? <SettingsPill>{t("den.private_badge")}</SettingsPill> : null}
          {row.installedName ? (
            <SettingsPill>{t("den.installed_name_badge", { name: row.installedName })}</SettingsPill>
          ) : null}
