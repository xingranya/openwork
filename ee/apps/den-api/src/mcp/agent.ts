...
export const AGENT_MCP_INSTRUCTIONS = [
  ...
  "不要编造 OAuth 客户端、凭据或本地扩展配置。公司连接由管理员后台和 SeeWayWork 的“公司连接”管理；需要管理员设置或成员登录时，准确转述返回的操作。",
  ...
  "即使本地 Schema 检查发现不一致，SeeWayWork 仍会尝试调用下游供应商。schemaGuidance 仅作提示；供应商成功时直接接受结果，失败时再按提示修正参数或重新检索。",
