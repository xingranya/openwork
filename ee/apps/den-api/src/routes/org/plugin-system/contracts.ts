...
export const pluginArchRoutePaths = {
  ...
  pluginSkillZipImport: `${orgBasePath}/plugins/import-skills-zip`,
...
export const pluginArchEndpointContracts: Record<string, EndpointContract> = {
  ...
  applyGithubConnectorDiscovery: {
    audience: "admin",
    description: "Create SeeWayWork plugins and connector mappings from selected GitHub discovery candidates.",
    method: "POST",
